...
Run and checkpoint ids accept **unique prefixes** — the first 8 characters are usually enough.
...
| `afr-regression-case <run_id> --from <ckpt> [-o DIR] [--name NAME] [--force]` | create `case.json`, a pytest template, and a README from a checkpoint |
